...
const CaptionBatchPage = () => {
    ...
    useEffect(() => {
        const filtered = Array.isArray(artworks) ? artworks.filter((a) => selectedIds.includes(a.id)) : [];
    ...
    const TemplateComponent = TEMPLATES[selectedTemplate as keyof typeof TEMPLATES] || CaptionTemplate1;
    const templateName = TEMPLATE_NAMES[selectedTemplate as keyof typeof TEMPLATE_NAMES] || '';
        ...
        <div className="container mx-auto py-8 max-w-none">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-gray-600 mt-2">
                        여러 작품을 선택하고, 한글/영문 캡션을 한 번에 출력/복사/내보내기 할 수 있습니다.
                    </p>
                </div>
            ...
            <div className="mb-6">
                ...
                >
                    ...
                    <option value={2}>템플릿 2 - 작가명 상단, 작품명 중앙, 상세정보 하단</option>
                    <option value={3}>템플릿 3 - 영문 우선 표시</option>
                    <option value={4}>템플릿 4 - 작품명 중앙 크게, 크기/재료/연도 하단</option>
                    ...
                    <div className="p-4 h-full">
                        {sidebarCollapsed ? (
                            ...
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <div className="text-sm font-semibold text-center">{selectedIds.length}</div>
                                            ...
                                            artworks.map((art) => (
                                                <div key={art.id} className="flex justify-center">
                                                    <input
                                                        ...
                                                        title={art.title_ko || art.title_en || '(제목 없음)'}
                                                    />
                                                </div>
                                            ))}
                                    </div>
                            ...
                            <>
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="text-sm text-gray-500">{selectedIds.length}개 선택됨</div>
                                </div>
                    ...
                    <div className="p-4 h-full" style={{ minHeight: '600px' }}>
                        <div className="flex items-center justify-between mb-4">
                            ...
                            {selectedIds.length > 0 && (
                                <div className="text-sm text-gray-500">{selectedIds.length}개 작품의 캡션</div>
                            )}
                        </div>
                                ...
                                <div className="flex items-center justify-center h-full text-gray-500">
                                    <div className="text-center">
                                        ...
                                        <div className="text-sm">
                                            좌측에서 캡션을 생성할 작품을 선택하면 여기에 미리보기가 표시됩니다.
                                        </div>
                                    </div>
                                </div>
                            ) : (
