  ...
  const filteredArtworks = useMemo(() => {
    return dummyArtworks
      .filter(artwork => {
        ...
        // 작가 필터링
        const matchesArtist = selectedArtist === null || 
          artwork.artist === selectedArtist;
  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        {/* 헤더 영역 */}
        <ArtworksHeader
          isAddArtworkDialogOpen={isAddArtworkDialogOpen}
          setIsAddArtworkDialogOpen={setIsAddArtworkDialogOpen}
