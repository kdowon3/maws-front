      ...
      <div className="flex">
        <div className="hidden md:block w-64 bg-white h-[calc(100vh-4rem)] border-r border-gray-200 overflow-y-auto overflow-x-hidden sticky top-16">
                ...
                {sidebarItems.map((item, index) => {
                  ...
                  return (
                    <li key={index}>
                      ...
                      >
                        <span
                          className={`mr-3 ${isActive ? "text-white" : "text-brand-blue"}`}
                        >
                          {item.icon}
                        </span>
          ...
          <div className="absolute bottom-4 w-64 p-4 border-t border-gray-100">
            <button
              onClick={logout}
              className="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-brand-lightGray w-full truncate overflow-hidden text-ellipsis whitespace-nowrap"
            >
