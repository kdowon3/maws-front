...
import { updateClient, getAllTags, createTag, updateClientTagsOnly } from '@/utils/api';
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const tagIds = Array.isArray(customerTags)
                ? customerTags.map((tag: any) => (typeof tag === 'object' ? tag.id : tag))
            ...
            if (tagIds.length > 0) {
                ...
                console.log('🏷️ EditClientDialog - 태그 업데이트 시작:', { tagIds, tagObjects });
            ...
            console.log('🏷️ EditClientDialog - 일반 데이터 업데이트:', dataWithoutTags);
