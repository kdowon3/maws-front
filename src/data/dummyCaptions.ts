...
export const variableSizeCaptions = [
  ...
  // 긴 제목, 복잡한 정보
  {
    ...
    title_en:
      "Philosophical Contemplation on the Contradictions of Modern Society and Individual Identity",
    artist_ko: "박매우긴이름입니다",
    artist_en: "Park This-is-a-very-long-name-indeed",
    year: "2023",
    medium:
      "Mixed media including oil, acrylic, charcoal, and digital elements",
    width: 180,
    height: 240,
    depth: 5,
    size_unit: "cm",
...
if (typeof window !== "undefined") {
  ...
  console.log(
    "사용법: testCaptions.basic (15개), testCaptions.large (30개), testCaptions.small (3개)",
  );
}
